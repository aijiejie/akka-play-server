...
case class ClientSubmitTask(dataPath: String, name: String)
...
case class AlsTask(alsMasterHost: String, alsMasterPort: String, alsDataPath: String, alsResultPath: String,
                   alsResultNumber: Int, alsName: String, alsRank: Int, numIterations: Int, delimiter: String)
...
case class DTTask(DTMasterHost: String, DTMasterPort: String, dtTrainDataPath: String, DataPath: String,
                  ...
                  impurity: String, maxDepth: Int, maxBins: Int, Delimiter: String)

case class DTTaskResult(modelResult: String, precison: String, predictResultPath: String)
...
case class RFTask(rfMasterHost: String, rfMasterPort: String, rfTrainDataPath: String, DataPath: String,
                  ...
                  featureSubsetStrategy: String, impurity: String, maxDepth: Int, maxBins: Int, Delimiter: String)

case class RFTaskResult(modelResult: String, precison: String, predictResultPath: String)
...
case class DTRTaskResult(modelResult: String, precison: String, predictResultPath: String)
